...
class Vis(object):
    ...
    def __init__(self, bcgColor=(1,1,1), pointSize = 0.2):
        ...
        self.colorFovPC = [0.0, 0.0, 0.0]  # field of view point cloud color
        self.colorRoadPC = [0, 128/255.0, 5/255.0]  # road point cloud color
        self.colorVehPC = [255/255.0, 255/255.0, 1/255.0]  # vehicle point cloud color
