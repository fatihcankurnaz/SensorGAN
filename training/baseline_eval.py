...
segmented_lidar_root = "/home/fatih/Inputs/TEST/2011_09_26_drive_0086_sync_lid"
cloud_root = "/SPACE/DATA/KITTI_Data/KITTI_labeledPC_with_BBs/2011_09_26/2011_09_26_drive_0086_sync"
rgb_root = "/SPACE/DATA/KITTI_Data/KITTI_raw_data/kitti/2011_09_26/2011_09_26_drive_0086_sync/image_02/data"
...
def baseline_eval(config, device):
    ...
    for file in sorted(listdir(segmented_lidar_root)):
        ...
        cloud_path = join(cloud_root,"full_label_2011_09_26_0086_"+ file.split(".")[0].split("_")[1]+".npy")
        ...
        plt.savefig("/home/fatih/my_git/sensorgan/outputs/baseline_eval_result2/"+file.split(".")[0].split("_")[1]+"eval.png")
