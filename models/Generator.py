...
class Generator(nn.Module):
    def __init__(self, in_channels=5, out_channels=3, ngpu=2):
        ...
        # self.down4 = UNetDown(64, 128, dropout=0.2)
        # self.down5 = UNetDown(128, 128, dropout=0.2)
        # # self.down6 = UNetDown(64, 64, dropout=0.5)
        # # self.down7 = UNetDown(64, 64, dropout=0.5)
        # self.down6 = UNetDown(128, 128, normalize=False, dropout=0.2)
        #
        # self.up1 = UNetUp(128, 128, dropout=0.2)
        # # self.up2 = UNetUp(128, 128, dropout=0.5)
        # # self.up3 = UNetUp(64, 64, dropout=0.5)
        # self.up4 = UNetUp(256, 128, dropout=0.2)
